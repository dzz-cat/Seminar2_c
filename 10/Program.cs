...
//Задачу можно решить несколькими способами. Варианты решения: 
...
// вариант с помощью вывода индекса нужного нам числа в цифре 
...
// Console.WriteLine($"Вторая цифра введенного числа: {substring}");
